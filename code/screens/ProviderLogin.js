     ...
     this.googleLogin=this.googleLogin.bind(this)
      ...
      async componentDidMount() {
       ...
       await GoogleSignin.configure({
          ...
          webClientId:
            '1020995126307-a3rru7s0p9g7vktqp1baf2btok5q2shk.apps.googleusercontent.com',
        });
      }
      ...
      render(){
        ...
        <KeyboardAvoidingView style={{justifyContenty:'center',width:wp('100%'),height:(this.state.orientation==="portrait")?hp('30%'):hp('50%')}}>
          ...
          <Button title='Continuar con el Email' onPress={()=>this.props.navigation.navigate('LoginScreen')}  containerStyle={{width:'65%',alignSelf:'center',borderRadius:50}}  buttonStyle={{backgroundColor:'#7F7472',alignSelf:'center',borderRadius:50,width:'100%'}} />
