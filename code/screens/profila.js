  ...
  handleImageUpload(){
    ...
    task.on('state_changed', (snapshot)=> {
      ...
      storageRef.getDownloadURL().then((downloadURL) => {
        ...
        }).catch(err=>Alert.alert('Ha falado',err))
      });
    })
  }
  render() {
...
<View style={{flexDirection:'row',justifyContent:'space-around'}}>
  <View style={{flexBasis:'70%'}}>
       {this.state.username.length>0 && <Text style={{fontSize:30,fontWeight:'bold',marginTop:10,marginLeft:15}}>{this.state.username}</Text>}
  </View>
...
<ScrollableTabView
 ...
 <TouchableOpacity onPress={()=>{
  ...
  {this.state.loading===false && this.state.sales.length===0 && <Text style={{fontWeight:'bold',textAlign:'center'}}>No hay listado en venta todavía</Text>}
  </ScrollView>
  <ScrollView tabLabel="Favoritos">
 ...
 <TouchableOpacity onPress={()=>{
  ...
  {this.state.loading===false && this.state.favorites.length===0 && <Text style={{fontWeight:'bold',textAlign:'center'}}>No Favoritos</Text>}
  </ScrollView>
  <ScrollView tabLabel="Compras">
 ...
 <TouchableOpacity onPress={()=>{
  ...
  {this.state.loading===false && this.state.purchases.length===0 && <Text style={{fontWeight:'bold',textAlign:'center'}}>Ningún artículo comprado todavía!</Text>}
  </ScrollView>
  </ScrollableTabView>
          </SafeAreaView>
    );
