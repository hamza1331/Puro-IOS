...
import { connect } from "react-redux";
 class ShippingForm extends Component {
   ...
   <SafeAreaView style={{flex:1}}>
     ...
     />
       ...
       centerComponent={{ text: 'Perfiles de Envios', style: { color: '#B46617',fontSize:20,marginBottom:10} }}
    ...
    <View style={{marginTop:25,marginLeft:15}}>
               <Text style={{color:'darkorange',fontSize:30}}>{this.state.title!==''?this.state.title:'Crear Perfil de Envio'}</Text>
             </View>
 ...
 <TextField
       ...
       />
        ...
        {this.state.loading===false && <Text style={{fontSize:20,color:'white',fontWeight:'bold'}}>Guardar</Text>}
