 ...
 class Orders extends Component{
   constructor(props){
    ...
    fetchOrders(){
     ...
     render(){
         return(
            <View style={{flex:1,alignItems:this.state.orders.length===0?"center":"flex-start",justifyContent:this.state.orders.length===0?"center":"flex-start"}}>
            <StatusBar barStyle='light-content'/>
            <Header  placement="left"
                  centerComponent={{ text: 'Pedidos', style: { color: 'white',fontSize:22,marginBottom:10} }}
                 ...
                 <TouchableOpacity onPress={()=>{
                   ...
                   this.props.showOrderModal()
                    ...
                    />}
                    {this.state.orders.length===0 && <Text style={{textAlign:"center",justifyContent:"center",alignSelf:"center",fontSize:22}}>
                    ¡Aún no hay pedidos!
                    </Text>}
                     </View>
                     <OrderDetails/>
