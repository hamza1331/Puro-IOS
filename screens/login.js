      ...
      render(){
        ...
        />
            ...
            <View style={{alignSelf:'flex-end',marginRight:10}}>
                <Text style={{color:'blue'}} onPress={this.handleReset}>Se te olvidó tu contraseña?</Text>
            </View>
          </View>
        ...
        <Button title="Iniciar sesión" onPress={this.handleSubmit} containerStyle={{borderRadius:15,width:'50%',marginBottom:5}}  buttonStyle={{backgroundColor:'#B17E4E',borderRadius:10}} />
          <Text style={{margin:5,fontWeight:'bold'}}>O</Text>
          <Button title="Registrate gratis" onPress={()=>this.props.navigation.navigate('Signup')}  containerStyle={{borderRadius:15,width:'50%'}}  buttonStyle={{backgroundColor:'#7F7472',borderRadius:10}} />
       </KeyboardAvoidingView>
   </ScrollView>
